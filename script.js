...
const textArray = ["Машуля","Прівєт❤️", "Хочу", "Тобі", "Нагадати", "Що...", "Ти", "Найкраща дівчина у світі", "Ти змушуєш моє серце битися швидше", "Ти мій найкращий друг і найбільше кохання одночасно", "Я ціную кожну мить, проведену з тобою"
...
canvas.addEventListener('click', (e) => {
  ...
  const x = centerX + (R() * 500 - 250); // Від -250 до +250
  const y = centerY + (R() * 500 - 250);
